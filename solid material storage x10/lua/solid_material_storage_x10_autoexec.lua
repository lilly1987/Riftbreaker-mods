...
local ResourceStorageDescSetup=function(name1,t ,multi )
	...
	local k="solid_material_storage_x10_autoexec.lua/" .. name1
...
ResourceStorageDescSetup("buildings/resources/solid_material_storage"		,"max",10)
ResourceStorageDescSetup("buildings/resources/solid_material_storage_lvl_2" ,"max",10)
ResourceStorageDescSetup("buildings/resources/solid_material_storage_lvl_3" ,"max",10)
