...
local ResourceStorageDescSetup=function (name1,t ,multi )
	...
	local k="energy_storage_x10_autoexec.lua/" .. my
...
ResourceStorageDescSetup("buildings/energy/energy_storage"		,"max",10)
ResourceStorageDescSetup("buildings/energy/energy_storage_lvl_2" ,"max",10)
ResourceStorageDescSetup("buildings/energy/energy_storage_lvl_3" ,"max",10)
