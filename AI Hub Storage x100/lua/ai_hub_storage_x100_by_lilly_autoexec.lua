...
local ResourceStorageDescSetup=function (name1,t ,multi )
	...
	ResourceStorageDescSetup("buildings/defense/ai_hub"		,"max",100)
	ResourceStorageDescSetup("buildings/defense/ai_hub_lvl_2" ,"max",100)
	ResourceStorageDescSetup("buildings/defense/ai_hub_lvl_3" ,"max",100)
